...
# ===========================================================
def move_hydrus_txt_to_folder(source_folder, source):
    ...
    for soil in soils_folders:
        ...
        copy_required_files_and_folders(subfolder, source)
...
for crosses in np.arange(dims[1]/8, dims[1], dims[1]/8):
    plot_title = _ti.format({0:'Theta', 1:'Head'}[variable], time_step,
                      {'x': 'Y-Z', 'y':'X-Z'}[section], section, crosses)
    draw_full_contour(data_frame,variable, time_step, grid, crosses, tol, section, 
                      levels, plot_title, fig_size=(2+13.2,12))
...
# # Recalculating all volumes and percents including Axi-pXZ relationships
...
# # source_folder = r'C:\Users\DrNesr\Documents\Extras\2L'.replace('\\','/')
# source_folder = r'C:\Users\DrNesr\Documents\Extras\4L'.replace('\\','/')
...
# ====== Performing studies on full domain and 7*5 grid =====
# ==============                                =============
# ============== INCLUDING AXI-pXZ relatioships =============
# ==============                                =============
# ===========================================================
...
get_packed_arrays(d3,variable=0, time_step=15, grid= 0.25, 
                      crosses=0., tol=10., section= 'y', is2d=False,
                      is_axisymmetric=True, levels=None,
                      get_two_arrays=False)
